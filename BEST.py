    ...
    def compareProcess(self):
        ...
        for i in range(1,5):
            ...
            for m in range(1,6):
                if i == m :
                    continue
                test_file_name = self.test_dir+'test'+str(m)
                result_file_name = self.result_dir+'result'+str(m)
                test_line = self.fileUtil.read_file(test_file_name)
                result_line = self.fileUtil.read_file(result_file_name)  
                print 'i '+str(i)+' - m '+str(m)+' file '+test_file_name, result_file_name
                for j in range(len(test_line)):
                    ...
                    try:
                        ...
                        print 'i '+str(i)+' - m '+str(m), ' correct ',pipe_msg_correct
                        ...
                        print 'i '+str(i)+' - m '+str(m),' time ',pipe_msg_time
